...
<form  method="post">
  ...
  <div class="form-group col-md-6">
      ...
      <select id="areas" class="form-control">
        ...
        <option>Derecho Aduanero</option>
        <option>Derecho Civil</option>
        <option>Derecho Constitucional</option>
        <option>Derecho Contencioso Administrativo</option>
    ...
    <div class="form-group col-md-6">
      <label for="delito">Asunto/Delito:</label>
      <input type="text" class="form-control" id="asunto/delito" placeholder="Asunto/Delito">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
  ...
  <center><input class="btn btn-lg btn-primary btn-block" type="submit" value="Registrar"></center>
</form>
<br>
</br>
